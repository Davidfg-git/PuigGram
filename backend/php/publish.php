    ...
    <div class="ContenedorPublicacion">
      <div class="primeraSeleccion">
        <div class="publicacion-container">
          ...
          <form id="form-publicacion" action="../../backend/php/uploadImage.php" method="POST"
    ...
    <div class="suggestions">
      ...
      <ul>
        <?php foreach ($sugerencias as $sugerencia): ?>
          <li>
            <img
              src="<?= !empty($sugerencia['imagen_perfil']) ? $sugerencia['imagen_perfil'] : '../../public/assets/default/default-image.jpg' ?>"
              alt="">
